...
<div class="Newsletter">
  ...
  <form
    ...
    action="https://tinyletter.com/matthewdrf"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/matthewdrf', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true">
